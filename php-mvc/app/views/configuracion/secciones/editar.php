        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" autocomplete="off">
                    <div class="mb-3">
                        ...
                        <select name="grado_id" class="form-select" required>
                            <?php foreach ($data['grados'] as $grado): ?>
                                <option value="<?= $grado->id ?>" <?= $grado->id == $data['seccion']->grado_id ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        <label class="form-label required">Nombre de la Sección</label>
                        <input type="text" name="nombre" class="form-control"
                               value="<?= $data['seccion']->nombre ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label required">Capacidad</label>
                        <input type="number" name="capacidad" class="form-control" min="1"
                               value="<?= $data['seccion']->capacidad ?>" required>
                    </div>
