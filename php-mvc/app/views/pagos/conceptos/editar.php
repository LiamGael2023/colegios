    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="ti ti-edit me-2"></i>Editar Concepto de Pago
                </h3>
            </div>
            <div class="card-body">
                ...
                <form method="POST" autocomplete="off">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control"
                               value="<?= $concepto->nombre ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Descripción</label>
                        <textarea name="descripcion" class="form-control" rows="2"><?= $concepto->descripcion ?></textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="monto" class="form-control"
                                   step="0.01" min="0" value="<?= $concepto->monto ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-check">
                            <input class="form-check-input" type="checkbox" name="es_recurrente" value="1"
                                   <?= $concepto->es_recurrente ? 'checked' : '' ?>>
