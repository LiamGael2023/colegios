    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="ti ti-edit me-2"></i>Editar Docente
                </h3>
            </div>
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control-plaintext">
                        <strong><?= $data['docente']->apellidos ?>, <?= $data['docente']->nombre ?></strong>
                        <br><small class="text-muted">DNI: <?= $data['docente']->dni ?> | <?= $data['docente']->email ?></small>
                    </div>
                </div>
                ...
                <form method="POST" autocomplete="off">
                    <div class="mb-3">
                        ...
                        <input type="text" name="especialidad" class="form-control"
                               value="<?= $data['docente']->especialidad ?>"
